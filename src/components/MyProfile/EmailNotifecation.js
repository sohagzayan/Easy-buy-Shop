    ...
    <div>
      <div>
        <div>
          ...
          <div className="mt-4">
            <span className="text-own-secondary dark:text-own-white mb-3 inline-block">
              Send me:
            </span>
            <div>
              ...
              <p className="text-own-secondary dark:text-own-white text-sm my-3">
                Get store news, announcements, and product updates
              </p>
              <hr />
            </div>
          </div>
