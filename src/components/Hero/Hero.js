...
const Hero = () => {
  return (
    <>
      <div class="">
        <div class="hero-content flex-col lg:flex-row-reverse py-16 relative ">
          <div className="w-full relative after:absolute after:bg-own-primary after:w-[30%] after:h-[100%] after:top-0 after:right-[25%] after:-z-[1] after:rounded-md after:opacity-50">
            <img src={clock} class="  rounded-lg mx-auto" alt="img" />
          </div>
          <div className="">
            ...
            <h1 class="text-5xl lg:text-6xl font-bold text-own-white  mt-4">
              Exclusive Clock and Hardware Fair
            </h1>
            <p class="py-6 text-own-text text-sm font-medium tracking-wider">
            ...
            <div className="flex items-center ">
              <button class="bg-own-primary text-own-white px-8 py-3 rounded-md text-white mr-3 ">
