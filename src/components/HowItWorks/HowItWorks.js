  ...
  return (
    <div className="mt-20 mb-10">
      <div>
        ...
        <h3 className="text-center text-4xl text-own-white">How It Works</h3>
        <p className="text-center text-own-text mb-16">
        ...
        <div className="grid grid-cols-3 gap-20">
          <div className="bg-own-ternary rounded-md p-4 flex items-center justify-center flex-col">
            ...
            <h3 className="text-own-white text-xl mb-6">
              Register New Account
            </h3>
            <p className="text-own-text text-center">
          ...
          <div className="bg-own-ternary p-4 flex items-center justify-center rounded-md flex-col">
            ...
            <h3 className="text-own-white text-xl mb-6">Setup Account Info</h3>
            <p className="text-own-text text-center">
              Lorem ipsum dolor, sit amet consectetur adipisicing elit. Adipisci
              rerum pariatur tenetur maxime esse asperiores, earum enim
              veritatis natus doloribus!
